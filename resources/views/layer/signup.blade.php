...
<div class="main-w3layouts wrapper">
    ...
    <div class="main-agileinfo">
        <div class="agileits-top">
            <form action="{{ route('layer.signupPross') }}" method="get">
                <input class="text" type="text" name="userName" placeholder="Username" required="">
                <input class="text email" type="email" name="userEmail" placeholder="Email" required="">
                <input class="text email" type="password" name="userPass" placeholder="Password" required="">
                <input class="text email" type="text" name="userAddress" placeholder="User Address" required="">
                <input class="text email" type="text" name="userPhone" placeholder="User Phone" required="">
